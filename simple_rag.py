...
def rag_pipeline(query, collection, llm_model, top_k=2):
    ...
    response = llm_model.generate_completion(
        [
            {
                "role": "system",
                "content": "You are a specialized space knowledge assistant. Only provide accurate, concise responses directly supported by the provided documents. Do not speculate or generate information outside the given sources",
            },
